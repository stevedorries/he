...
import { he } from "../mod.ts";
import { testDataMap, stringInvalidCodePoints } from "../src/scripts/export-data.ts";

let expect = '\0&#x1;&#x2;&#x3;&#x4;&#x5;&#x6;&#x7;&#x8;&#xB;&#xE;&#xF;&#x10;&#x11;&#x12;&#x13;&#x14;&#x15;&#x16;&#x17;&#x18;&#x19;&#x1A;&#x1B;&#x1C;&#x1D;&#x1E;&#x1F;&#x7F;\x80&#x81;\x82\x83\x84\x85\x86\x87\x88\x89\x8A\x8B\x8C&#x8D;\x8E&#x8F;&#x90;\x91\x92\x93\x94\x95\x96\x97\x98\x99\x9A\x9B\x9C&#x9D;\x9E\x9F&#xFDD0;&#xFDD1;&#xFDD2;&#xFDD3;&#xFDD4;&#xFDD5;&#xFDD6;&#xFDD7;&#xFDD8;&#xFDD9;&#xFDDA;&#xFDDB;&#xFDDC;&#xFDDD;&#xFDDE;&#xFDDF;&#xFDE0;&#xFDE1;&#xFDE2;&#xFDE3;&#xFDE4;&#xFDE5;&#xFDE6;&#xFDE7;&#xFDE8;&#xFDE9;&#xFDEA;&#xFDEB;&#xFDEC;&#xFDED;&#xFDEE;&#xFDEF;&#xFFFE;&#xFFFF;&#x1FFFE;&#x1FFFF;&#x2FFFE;&#x2FFFF;&#x3FFFE;&#x3FFFF;&#x4FFFE;&#x4FFFF;&#x5FFFE;&#x5FFFF;&#x6FFFE;&#x6FFFF;&#x7FFFE;&#x7FFFF;&#x8FFFE;&#x8FFFF;&#x9FFFE;&#x9FFFF;&#xAFFFE;&#xAFFFF;&#xBFFFE;&#xBFFFF;&#xCFFFE;&#xCFFFF;&#xDFFFE;&#xDFFFF;&#xEFFFE;&#xEFFFF;&#xFFFFE;&#xFFFFF;&#x10FFFE;&#x10FFFF;';
//console.log(expect+"\n\n\n\n");
...
console.log(err !== undefined ? err.message : `
Equal?:   ${act === expect}
Actual:   ${act}
Expected: ${expect}
`);
...
const noop = Function.prototype;
	...
	const officialData = testDataMap;
	const encodeData = [
		{
			'decoded': 'a\xC1b',
			'encoded': 'a&Aacute;b'
	...
	test(function decodeTests() {
		...
		assertThrows(
			...
			Error,
			"Parse error: character reference was not terminated by a semicolon"
		);
		assertEquals(
		...
		assertThrows(
			...
			Error,
			"Parse error: disallowed character reference"
		);
		assertEquals(
			he.decode('&#xD;'),
			'\x0D',
		...
		assertThrows(
			...
			Error,
			"Parse error: malformed character reference"
		);
		assertEquals(
			he.decode('&#Z', {
				'strict': false
	...
	test(function encodeTests() {
		
		// Test encoding
		forEach(encodeData, function(item) {
			const actualEncoded = he.encode(item.decoded, {useNamedReferences: true});
			assertEquals(
				actualEncoded,
				item.encoded,
				`
...
Got:      ${actualEncoded}`
		...
		assertThrows(() => he.encode('a<\xE4>', { 'decimal': true, 'allowUnsafeSymbols': false }),
			Error,
